...
class UserTest < ActiveSupport::TestCase
  def setup
    @user = User.new(first_name: "Test", last_name: "Ninja", email: "test.ninja@meltwater.org", sex: "male", nationality: "ghana", user_type: "eit")
  end
  ...
  test "Email address should be unique" do
    @user1 = User.new(first_name: "Test", last_name: "Ninja", email: "test.ninja@meltwater.org")

    if  @user1.email.upcase = @user.email.upcase
         assert_not @user1.valid?, "#{email.inspect} should be unique"
    end
  end
